...
public class DealAdapter extends RecyclerView.Adapter<DealAdapter.DealViewHolder>{
    ...
    public DealAdapter() {
        ...
        mChildListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                MyJournal td = dataSnapshot.getValue(MyJournal.class);
    ...
    public void onBindViewHolder(DealViewHolder holder, int position) {
        MyJournal deal = deals.get(position);
        holder.bind(deal);
    }
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder
        ...
        public void bind(MyJournal deal) {
        ...
        public void onClick(View view) {
            ...
            MyJournal selectedDeal = deals.get(position);
